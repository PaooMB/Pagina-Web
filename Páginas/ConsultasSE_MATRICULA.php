...
<div id="cuerpo">
<h1>Consultas</h1><h1 style="font-size:40px">"SE_MATRICULA"</h1>
<?php 
...
<?php 
 ...
 $conex = mysqli_connect("localhost","usuarioWeb") or die("ERROR...");
	...
	$resultado = mysqli_query($conex,"SELECT * FROM SE_MATRICULA WHERE AlumnoID='$AlumnoID' AND CursoID='$CursoID'");
		if($resultado->num_rows>0){
		$row=$resultado->fetch_assoc();
	echo "<p>Los resultados obtenidos para la busqueda son:</p>";
		echo " <p><b>Importe:</b>".$row['Importe']."</p>";
		echo " <p><b>Fecha_de_compra:</b>".$row['Fecha_de_compra']."</p>";
}
	else
