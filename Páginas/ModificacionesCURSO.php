...
<div id="cuerpo">
<h1>Modificaciones</h1><h1 style="font-size:40px">"CURSO"</h1>
<?php 
...
Nombre_Curso :  <input name= "varNombre_Curso" type="text" style="width:140px; margin:5px;border:1px solid steelblue; padding:5px; border-radius:5px" value="">
<br/>
...
<?php 
 ...
 $conex = mysqli_connect("localhost","usuarioWeb") or die("ERROR...");
	mysqli_select_db($conex,"DeraWebBD") or die("ERROR CON LA BASE DE DATOS");
		...
		$Nombre_Curso = $_GET['varNombre_Curso'];
	$resultado = mysqli_query($conex,"UPDATE CURSO SET Nombre_Curso='$Nombre_Curso' WHERE CursoID='$CursoID'");
