...
<div id="cuerpo">
<h1>Modificaciones</h1><h1 style="font-size:40px">"AREAS_DE_INTERES"</h1>
<?php 
if (!(isset($_GET['varAreaID']))){
?>
<p>Escriba el identificador del elemento a modificar:</p>
<form class="linea1">
<p><i><u>AreaID</u> : </i><input name= "varAreaID" type="text" style=" margin:10px 5px 10px 4px; width:140px; margin:5px; border:1px solid steelblue; padding:5px; border-radius:5px" value="">
<br/>
<p>Introduzca los nuevos valores:</p>
Nombre_Area :  <input name= "varNombre_Area" type="text" style="width:140px; margin:5px;border:1px solid steelblue; padding:5px; border-radius:5px" value="">
<br/>
...
<?php 
 ...
 $conex = mysqli_connect("localhost","usuarioWeb") or die("ERROR...");
	mysqli_select_db($conex,"DeraWebBD") or die("ERROR CON LA BASE DE DATOS");
		...
		$Nombre_Area = $_GET['varNombre_Area'];
	$resultado = mysqli_query($conex,"UPDATE AREAS_DE_INTERES SET Nombre_Area='$Nombre_Area' WHERE AreaID='$AreaID'");
