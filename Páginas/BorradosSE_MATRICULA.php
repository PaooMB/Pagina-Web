...
<div id="cuerpo">
<h1>Borrados</h1><h1 style="font-size:40px">"SE_MATRICULA"</h1>
<?php 
...
<?php 
 ...
 $conex = mysqli_connect("localhost","usuarioWeb") or die("ERROR...");
	...
	$resultado = mysqli_query($conex,"DELETE FROM SE_MATRICULA WHERE CursoID='$CursoID'  AND AlumnoID='$AlumnoID' ");
