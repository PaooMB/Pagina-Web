...
<div id="cuerpo">
<h1>Consultas</h1><h1 style="font-size:40px">"AREAS_DE_INTERES"</h1>
<?php 
...
<?php 
 ...
 $conex = mysqli_connect("localhost","usuarioWeb") or die("ERROR...");
	...
	$resultado = mysqli_query($conex,"SELECT * FROM AREAS_DE_INTERES WHERE AreaID='$AreaID'");
		if($resultado->num_rows>0){
		$row=$resultado->fetch_assoc();
		echo " <p>Los datos obtenidos para la busqueda son:</p>";
		echo " <p><b>Nombre_Area:</b>".$row['Nombre_Area']."</p>";
}
	else
