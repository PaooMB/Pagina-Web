...
<div id="cuerpo">
<h1>Inserciones</h1><h1 style="font-size:40px">"ALUMNO"</h1>
<?php 
...
<?php 
 ...
 $conex = mysqli_connect("localhost","usuarioWeb") or die("ERROR...");
	...
	$resultado = mysqli_query($conex,"INSERT INTO ALUMNO VALUES ( '$DNI', '$Apellidos', '$Nombre', '$Correo', '$Telefono','$AlumnoID')");
