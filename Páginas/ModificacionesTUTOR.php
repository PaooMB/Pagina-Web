...
<div id="cuerpo">
<h1>Modificaciones</h1><h1 style="font-size:40px">"TUTOR"</h1>
<?php 
...
<?php 
 ...
 $conex = mysqli_connect("localhost","usuarioWeb") or die("ERROR...");
	...
	$resultado = mysqli_query($conex,"UPDATE TUTOR SET Nombre='$Nombre' ,Apellidos='$Apellidos' WHERE TutorID='$TutorID'");
